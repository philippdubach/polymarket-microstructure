...
1{,}300--1{,}800\,bps half-spread on Polymarket's lowest-probability
decile is an order of magnitude wider, which reads less like the
classical risk-love or misperception story and more like a
liquidity-provision constraint: low-probability binary contracts
...
specification implied. We treat the category + log-volume
specification as the conservative reading: volume mediates the
...
The headline 0.305 coefficient is the residual depth decay after
that mediation is netted out.
