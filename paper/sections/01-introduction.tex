...
prediction-market microstructure, and \citet{tsang-yang-2026} document
transaction-level patterns in the 2024 US presidential election
market. Neither authoritative on-chain trade direction nor a
continuous off-chain order-book archive has been brought to bear at
the cross-sectional scale we use here.
